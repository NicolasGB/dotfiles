...
$env.config = {
    ...
    keybindings: [
        ...
        {
            name: delete_one_character_backward_2
            modifier: control
            keycode: char_h
            mode: [emacs, vi_insert]
            event: { edit: backspace }
        ...
        {
            name: move_one_word_right_or_take_history_hint_3
            modifier: alt
            keycode: char_f
            mode: emacs
            event: {
